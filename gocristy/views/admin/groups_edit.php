...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="h2 sub-header"><?php echo $this->lang->line('user_group_new') ?>  <a role="button" href="<?php echo $this->GoCristy_model->base_link() ?>/admin/groups/add" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-plus"></span> <?php echo $this->lang->line('user_group_new') ?></a></div>
        <?php echo form_open($this->GoCristy_model->base_link(). '/admin/groups/update/' . $group->user_groups_id); ?>
                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-body no-padding">
                        ...
                        <?php foreach($b_perms as $value){ 
                            if($this->GoCristy_auth_model->is_group_allowed($value['user_perms_id'], 'backend', $group->user_groups_id) !== FALSE){
                                $allowactive = ' active';
                                $denyactive = '';
                                $allowchk = ' checked';
                                $denychk = '';
                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-body no-padding">
                        ...
                        <?php foreach($f_perms as $value){ 
                            if($this->GoCristy_auth_model->is_group_allowed($value['user_perms_id'], 'frontend', $group->user_groups_id) !== FALSE){
                                $fallowactive = ' active';
                                $fdenyactive = '';
                                $fallowchk = ' checked';
                                $fdenychk = '';
