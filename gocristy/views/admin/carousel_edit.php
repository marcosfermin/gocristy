...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="h2 sub-header"><?php echo $this->lang->line('carousel_edit'); ?> <a class="btn btn-default btn-sm" href="<?php echo $this->GoCristy_referrer->getIndex(); ?>"><span class="glyphicon glyphicon-arrow-left"></span> <?php echo $this->lang->line('btn_back'); ?></a></div>
        <?php echo form_open_multipart($this->GoCristy_model->base_link(). '/admin/carousel/update/'.$this->uri->segment(4)); ?>
    ...
    <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <?php echo form_open($this->GoCristy_model->base_link(). '/admin/carousel/addYoutube/'.$this->uri->segment(4)) ?>
            ...
            <div class="col-md-4">
                ...
                <?php echo form_open($this->GoCristy_model->base_link(). '/admin/carousel/addUrl/'.$this->uri->segment(4)) ?>
            ...
            <div class="col-md-4">  
                ...
                <?php echo form_open_multipart($this->GoCristy_model->base_link(). '/admin/carousel/filesUpload/'.$this->uri->segment(4)) ?>
                <input type="hidden" name="carousel_type" value="multiimages">
        ...
        <?php echo  form_open($this->GoCristy_model->base_link(). '/admin/carousel/filesSave'); ?>
