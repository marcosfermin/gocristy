...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="h2 sub-header"><?php echo  $this->lang->line('pages_addnew') ?>  <a role="button" href="<?php echo  $this->GoCristy_model->base_link() ?>/admin/pages/new" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-plus"></span> <?php echo  $this->lang->line('pages_addnew') ?></a></div>
        <?php echo form_open($this->GoCristy_model->base_link(). '/admin/pages/insert'); ?>
        ...
        <div class="control-group">	
            ...
            $data = array(
                ...
                'class' => 'form-control',
                'maxlength' => '255',
                'value' => set_value('page_name', $this->GoCristy_admin_model->getDraftArray('page_name') , FALSE)
            );
        ...
        <div class="control-group">	
            ...
            $data = array(
                ...
                'class' => 'form-control',
                'maxlength' => '255',
                'value' => set_value('page_title', $this->GoCristy_admin_model->getDraftArray('page_title'), FALSE)
            );
            echo form_input($data);
            ?>				
        </div> <!-- /control-group -->
        ...
        <div class="control-group">	
            ...
            $data = array(
                ...
                'class' => 'form-control',
                'maxlength' => '255',
                'value' => set_value('page_keywords', $this->GoCristy_admin_model->getDraftArray('page_keywords'), FALSE)
            );
            echo form_input($data);
            ?>				
        </div> <!-- /control-group -->
        ...
        <div class="control-group">
            ...
            $data = array(
                ...
                'autofocus' => 'true',
                'class' => 'form-control',
                'value' => set_value('page_desc', $this->GoCristy_admin_model->getDraftArray('page_desc'), FALSE)
            );
            echo form_input($data);
            ?>			
        </div> <!-- /control-group -->
        ...
        <div class="control-group">	
            ...
            <?php
                ...
                echo form_dropdown('lang_iso', $data, $this->GoCristy_admin_model->getDraftArray('lang_iso'), $att);
            ?>	
        </div> <!-- /control-group -->
        <br>
        <div class="control-group">										
        ...
        <br>
        <?php if($this->GoCristy_auth_model->is_group_allowed('pages cssjs additional', 'backend') !== FALSE){ ?>
            <div class="control-group">            
                ...
                $data = array(
                    ...
                    'id' => 'more_metatag',
                    'class' => 'form-control',
                    'value' => set_value('more_metatag', $this->GoCristy_admin_model->getDraftArray('more_metatag'), FALSE)
                );
            ...
            <div class="control-group">            
                ...
                $data = array(
                    ...
                    'id' => 'custom_css',
                    'class' => 'form-control',
                    'value' => set_value('custom_css', $this->GoCristy_admin_model->getDraftArray('custom_css'), FALSE)
                );
                echo form_textarea($data);
                ?>			
            </div> <!-- /control-group -->
            <div class="control-group">            
                ...
                $data = array(
                    ...
                    'id' => 'custom_js',
                    'class' => 'form-control',
                    'value' => set_value('custom_js', $this->GoCristy_admin_model->getDraftArray('custom_js'), FALSE)
                );
                echo form_textarea($data);
                ?>			
            </div> <!-- /control-group -->
        ...
        <div class="control-group">
            ...
            <textarea name="content" id="content" class="form-control body-tinymce"><?php if($this->GoCristy_admin_model->getDraftArray('content')){ echo $this->GoCristy_admin_model->getDraftArray('content'); }else{ echo $starter_html; } ?></textarea>
        </div> <!-- /control-group -->
        <br><br>
        <?php
            $data = array(
        ...
        <div class="form-actions">
            ...
            ?> 
            <a class="btn btn-lg" href="<?php echo $this->GoCristy_referrer->getIndex(); ?>"><?php echo $this->lang->line('btn_cancel'); ?></a>
        </div> <!-- /form-actions -->
        <?php echo form_close(); ?>
        <!-- /widget-content --> 
    </div>
