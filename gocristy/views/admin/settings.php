...
<!-- /.row -->
<?php echo form_open_multipart($this->GoCristy_model->base_link().'/admin/settings/update'); ?>
<div class="row">
    <div class="col-lg-6 col-md-6">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                ?>
                <span class="remark"><em><a href="<?php echo $this->GoCristy_model->base_link(); ?>/admin/filemanager" title="<?php echo $this->lang->line('filemanager_template_create').' '.$this->lang->line('banner_link'); ?>!"><b><?php echo $this->lang->line('filemanager_template_create').' '.$this->lang->line('banner_link'); ?>!</b></a></em></span>
            </div> <!-- /controls -->				
        </div> <!-- /control-group -->
        <div class="control-group">
    ...
    <div class="col-lg-6 col-md-6">
        ...
        <a href="<?php echo $this->GoCristy_model->base_link().'/admin/settings/gensitemap' ?>" class="btn btn-success" title="<?php echo $this->lang->line('settings_sitemap_runnow') ?>"><?php echo $this->lang->line('settings_sitemap_runnow') ?></a><br>
        ...
        <div class="control-group">	
            ...
            <div class="controls">
                <div class="input-group">
                    ...
                    echo form_input($data);
                    ?>
                    <div class="input-group-btn"><a href="<?php echo $this->GoCristy_model->base_link().'/admin/settings/testsendmail' ?>" class="btn btn-primary" title="<?php echo $this->lang->line('settings_email_testbtn') ?>"><?php echo $this->lang->line('settings_email_testbtn') ?></a></div>
                </div>
            </div> <!-- /controls -->				
        </div> <!-- /control-group -->
        <div class="control-group">										
