...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="h2 sub-header"><?php echo  $this->lang->line('user_edit_header') ?>  <a role="button" href="<?php echo  $this->GoCristy_model->base_link() ?>/admin/members/new" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-plus"></span> <?php echo  $this->lang->line('user_addnew') ?></a></div>
        <?php echo form_open_multipart($this->GoCristy_model->base_link().'/admin/members/edited/'.$this->uri->segment(4)); ?>
        ...
        <div class="control-group">	
            ...
            <?php
                ...
                $user_group = $this->GoCristy_auth_model->get_groups_fromuser($users->user_admin_id);
