...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <br>
        <form id="table_sel">
            <b><?php echo $this->lang->line('db_table_name') ?>: </b><select onchange="this.options[this.selectedIndex].value && (window.location = '<?php echo $this->GoCristy_model->base_link()?>/admin/export/'+this.options[this.selectedIndex].value);">
...
<?php if($this->uri->segment(3) && $this->db->table_exists($this->uri->segment(3))) { ?>
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="h2 sub-header"><?php echo $this->lang->line('db_table_name') ?>: <?php echo $this->uri->segment(3) ?> <a role="button" href="<?php echo $this->GoCristy_referrer->getIndex()?>" class="btn btn-default btn-sm"><i class="glyphicon glyphicon-arrow-left"></i> <?php echo  $this->lang->line('btn_back') ?></a></div>
            <?php echo form_open($this->GoCristy_model->base_link(). '/admin/export/getcsv/'.$this->uri->segment(3), array('method="get"')) ?>
            ...
            <?php echo form_close(); ?>
            <!-- /.box -->
            <?php echo form_open_multipart($this->GoCristy_model->base_link(). '/admin/export/importcsv/'.$this->uri->segment(3)) ?>
