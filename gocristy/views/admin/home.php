<?php $config = $this->GoCristy_admin_model->load_config(); ?>
            ...
            <div class="col-sm-12">
                <div class="box box-primary">
                    ...
                    <div class="box-footer">
                        <p><b><a href="http://www.gocristy.com" target="_blank"><?php echo $this->lang->line('dash_gocristy_link') ?></a></b></p>
                    </div>
                </div>
                <!-- /.box -->
            </div>
                    ...
                    <div class="box-body">
                        <div class="row col-sm-12">
                                <div class="panel panel-green">
                                    ...
                                    <a href="<?php echo $this->GoCristy_model->base_link().'/admin/members' ?>">
                        ...
                        <div class="row col-sm-12">
                                <div class="panel panel-yellow">
                                    ...
                                    <a href="<?php echo $this->GoCristy_model->base_link().'/admin/linkstats'; ?>">
                                        <div class="panel-footer">
                                            <span class="pull-left"><?php echo $this->lang->line('dashboard_viewdetail'); ?></span>
                                            <span class="pull-right"><i><span class="glyphicon glyphicon-expand"></span></i></span>
                                            <div class="clearfix"></div>
                        ...
                        <div class="row col-sm-12">
                                <div class="panel panel-red">
                                    ...
                                    <a href="<?php echo $this->GoCristy_model->base_link().'/admin/emaillogs' ?>">
                                        <div class="panel-footer">
                                            <span class="pull-left"><?php echo $this->lang->line('dashboard_viewdetail') ?></span>
                                            <span class="pull-right"><i><span class="glyphicon glyphicon-expand"></span></i></span>
                                            <div class="clearfix"></div>
        ...
        <div class="row">
            <div class="col-md-12" style="word-wrap:break-word;">
                <div class="list-group">
                    <?php if ($this->GoCristy_auth_model->is_group_allowed('email logs', 'backend') === FALSE){ ?>
                        ...
                        <?php } else { ?>
                            ...
                            <span class="list-group-item">
                                ...
                                <div class="control-group text-right">
                                    <a class="btn btn-danger btn-sm" role="button" onclick="return confirm('<?php echo $this->lang->line('delete_message')?>')" href="<?php echo $this->GoCristy_model->base_link().'/admin/admin/deleteEmailLogs/'.$el['email_logs_id']?>">
...
<div class="box box-info">
    ...
    <div class="box-body">
        <div class="row">
            <div class="col-md-12" style="word-wrap:break-word;">
                <div class="list-group">
                    <?php if ($this->GoCristy_auth_model->is_group_allowed('linkstats', 'backend') === FALSE){ ?>
                        <div class="list-group-item">
                            <span class="badge"><?php echo date('Y-m-d H:i:s')?></span>
                            <b><?php echo  $this->lang->line('user_not_allow_txt') ?></b>
                        </div> 
                ...
                <div class="text-right">
                    <a href="<?php echo $this->GoCristy_model->base_link().'/admin/linkstats' ?>" style="text-decoration: none;"><?php echo $this->lang->line('dashboard_viewdetail') ?> <i><span class="glyphicon glyphicon-expand"></span></i></a>
                </div>
            </div>
        </div>
    </div>
