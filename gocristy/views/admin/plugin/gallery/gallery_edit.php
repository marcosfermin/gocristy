...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="h2 sub-header"><?php echo $this->lang->line('btn_edit').' '.$this->lang->line('gallery_new_header'); ?> <a class="btn btn-default btn-sm" href="<?php echo $this->GoCristy_referrer->getIndex('gallery'); ?>"><span class="glyphicon glyphicon-arrow-left"></span> <?php echo $this->lang->line('btn_back'); ?></a></div>
        <?php echo form_open_multipart($this->GoCristy_model->base_link(). '/admin/plugin/gallery/editSave/'.$this->uri->segment(5)); ?>
    ...
    <div class="col-lg-12 col-md-12">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6">
                ...
                <?php echo  form_open($this->GoCristy_model->base_link(). '/admin/plugin/gallery/addYoutube/'.$this->uri->segment(5)) ?>
            ...
            <div class="col-lg-6 col-md-6">  
                ...
                <?php echo  form_open_multipart($this->GoCristy_model->base_link(). '/admin/plugin/gallery/htmlUpload/'.$this->uri->segment(5)) ?>
        ...
        <?php echo  form_open($this->GoCristy_model->base_link(). '/admin/plugin/gallery/uploadIndexSave'); ?>
