...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="h2 sub-header"><?php echo $this->lang->line('carousel_new'); ?> <a class="btn btn-default btn-sm" href="<?php echo $this->GoCristy_referrer->getIndex(); ?>"><span class="glyphicon glyphicon-arrow-left"></span> <?php echo $this->lang->line('btn_back'); ?></a></div>
        <?php echo form_open_multipart($this->GoCristy_model->base_link(). '/admin/carousel/insert'); ?>
