...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="h2 sub-header"><?php echo  $this->lang->line('lang_addnew') ?>  <a role="button" href="<?php echo  $this->GoCristy_model->base_link() ?>/admin/lang/new" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-plus"></span> <?php echo  $this->lang->line('lang_addnew') ?></a></div>
        <?php echo form_open($this->GoCristy_model->base_link(). '/admin/lang/edited/'.$this->uri->segment(4)); ?>
