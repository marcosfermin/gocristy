...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="h2 sub-header"><?php echo  $this->lang->line('carousel_header') ?> <a role="button" href="<?php echo $this->GoCristy_model->base_link()?>/admin/carousel/add" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-plus"></span> <?php echo  $this->lang->line('carousel_new') ?></a></div>        
        <?php echo  form_open($this->GoCristy_model->base_link(). '/admin/carousel/deleteIndex'); ?>
                ...
                <tbody>
                    ...
                    <?php } else { ?>
                        ...
                        foreach ($carousel as $u) {
                            ...
                            echo '<td class="text-center"'.$inactive.'><a href="'.$this->GoCristy_model->base_link().'/admin/carousel/edit/' . $u['carousel_widget_id'] . '" class="btn btn-default btn-sm" role="button"><i class="glyphicon glyphicon-pencil"></i>  '.$this->lang->line('btn_edit').'</a>';
                            echo '</td></tr>';
                        }
                        ?>
                    <?php } ?>
