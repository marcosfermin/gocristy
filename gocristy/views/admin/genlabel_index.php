                ...
                <tbody>
                    ...
                    <?php } else { ?>
                        ...
                        foreach ($genlab as $gl) {
                            ...
                            echo '</td>';
                            echo '<td class="text-center"><a href="'.$this->GoCristy_model->base_link().'/admin/genlabel/edit/' . $gl['general_label_id'] . '" class="btn btn-default btn-sm" role="button"><i class="glyphicon glyphicon-pencil"></i>  '.$this->lang->line('btn_edit').'</a></td>';
                            echo '</tr>';
                        } ?>
                    <?php } ?>
                </tbody>
