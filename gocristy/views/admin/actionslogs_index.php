...
<div class="row">
    <div class="col-lg-12 col-md-12">
        ...
        <form action="<?php echo $this->GoCristy_model->base_link(). '/admin/actionslogs/'; ?>" method="get">
        ...
        <br><br>
        <?php echo  form_open($this->GoCristy_model->base_link(). '/admin/actionslogs/deleteindex'); ?>
