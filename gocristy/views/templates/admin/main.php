...
$row = $this->GoCristy_admin_model->load_config();
/**
...
<html lang="<?php echo $row->admin_lang ?>">
    <head>
        <meta http-equiv="refresh" content="7205;url=<?php echo $this->GoCristy_model->base_link().'/admin/logout'; ?>" />
	...
	<link rel="icon" sizes="192x192" href="<?php echo base_url('', '', TRUE) ?>templates/admin/img/gocristy_icon_192.png">
	<link rel="apple-touch-icon" sizes="128x128" href="<?php echo base_url('', '', TRUE) ?>templates/admin/img/gocristy_icon_128.png" />
	<link rel="apple-touch-icon" sizes="152x152" href="<?php echo base_url('', '', TRUE) ?>templates/admin/img/gocristy_icon_152.png" />
        <link rel="manifest" href="<?php echo $this->GoCristy_model->base_link() ?>/admin/manifest">
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <?php if($this->session->userdata('user_admin_id') && $this->session->userdata('admin_email') && $this->session->userdata('admin_logged_in')){ ?>
            <?php $users = $this->GoCristy_admin_model->getUser($this->session->userdata('user_admin_id')); /* Get admin user information */
            ($users->picture) ? $user_img = base_url() . 'photo/profile/' . $users->picture : $user_img = base_url() . 'photo/no_image.png'; ?>
            <div class="wrapper">
                <!-- Start topbar -->
                <header class="main-header">
                    <!-- Logo -->
                    <a class="logo" href="<?php echo $this->GoCristy_model->base_link().'/admin'; ?>">
                    ...
                    <nav class="navbar navbar-static-top">
                        ...
                        <div class="navbar-custom-menu">
                            <ul class="nav navbar-nav">
                                ...
                                <?php if($this->GoCristy_auth_model->is_group_allowed('pm', 'backend') !== FALSE){
                                    ...
                                    <li class="dropdown messages-menu">
                                      ...
                                      <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            ...
                                            <ul class="menu">
                                              <?php $unread_msg = $this->GoCristy_auth_model->list_pms(10, 0, $this->session->userdata('user_admin_id'), '', TRUE);
                                              if($unread_msg !== FALSE){
                                              foreach($unread_msg as $value){ ?>
                                                  <!-- start message -->
                                                  <li>
                                                    <a href="<?php echo $this->GoCristy_model->base_link(); ?>/admin/pm/view/<?php echo $value['id']; ?>">
                                                        <div class="pull-left" style="margin-top:-5px;">
                                                          <i class="fa fa-envelope"></i>
                                                      </div>
                                                        <h4 style="margin: 0 0 0 20px;">
                                                        <?php echo $this->GoCristy_admin_model->getUser($value['sender_id'])->name ?>
                                        ...
                                        <li class="footer"><a href="<?php echo $this->GoCristy_model->base_link(); ?>/admin/pm"><b><?php echo $this->lang->line('pm_seeall_msg') ?></b></a></li>
                                      </ul>
                                    </li>
                                <?php } ?>
                                <li>
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="user-header">
                                            ...
                                            <p>
                                                ...
                                                <?php $user_group = $this->GoCristy_auth_model->get_groups_fromuser($users->user_admin_id); ?>
                                        ...
                                        <li class="user-footer">
                                            <div class="pull-left">
                                                <a href="<?php echo $this->GoCristy_model->base_link(); ?>/admin/users/edit/<?php echo $this->session->userdata('user_admin_id'); ?>" class="btn btn-default btn-flat"><i class="fa fa-edit"></i> <?php echo $this->lang->line('user_edit_header'); ?></a>
                                            </div>
                                            <div class="pull-right">
                                                <a href="<?php echo $this->GoCristy_model->base_link(); ?>/admin/logout" class="btn btn-default btn-flat"><i class="fa fa-sign-out text-red"></i> <?php echo $this->lang->line('nav_logout'); ?></a>
                                            </div>
                                        </li>
                                    </ul>
                                </li>
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="<?php echo $this->GoCristy_model->base_link(). '/admin/upgrade/optimize' ?>"><i class="fa fa-compress"></i> <?php echo $this->lang->line('btn_optimize_db') ?></a></li>
                                        <li><a href="<?php echo $this->GoCristy_model->base_link(). '/admin/upgrade/clearAllCache' ?>" onclick="return confirm('<?php echo $this->lang->line('delete_message') ?>');"><i class="fa fa-trash"></i> <?php echo $this->lang->line('btn_clearallcache') ?></a></li>
                                        <li><a href="<?php echo $this->GoCristy_model->base_link(). '/admin/upgrade/clearAllDBCache' ?>" onclick="return confirm('<?php echo $this->lang->line('delete_message') ?>');"><i class="fa fa-trash"></i> <?php echo $this->lang->line('btn_clearalldbcache') ?></a></li>
                                        <li><a href="<?php echo $this->GoCristy_model->base_link(). '/admin/upgrade/clearAllSession' ?>" onclick="return confirm('<?php echo $this->lang->line('clear_sess_message') ?>');"><i class="fa fa-sign-out text-red"></i> <?php echo $this->lang->line('btn_clear_sess') ?></a></li>
                                        <?php if($this->GoCristy_auth_model->is_group_allowed('export', 'backend') !== FALSE){ ?><li><a href="<?php echo $this->GoCristy_model->base_link(). '/admin/export' ?>"><i class="glyphicon glyphicon-export"></i> <?php echo $this->lang->line('export_import_csv_btn') ?></a></li><?php } ?>
                                    </ul>
                                </li>
                    ...
                    <section class="sidebar">
                        ...
                        <div class="user-panel">
                            ...
                            <div class="pull-left info">
                                ...
                                <a href="<?php echo $this->GoCristy_model->base_link(); ?>/admin/users/edit/<?php echo $this->session->userdata('user_admin_id'); ?>"><i class="fa fa-edit"></i> <b><?php echo $this->lang->line('user_edit_header'); ?></b></a>
                            </div>
                        </div>
                        <!-- search form -->
                ...
                <div class="content-wrapper">
                    <div class="container-fluid">
                        ...
                        <?php if($this->GoCristy_admin_model->chkVerUpdate($this->GoCristy_model->getVersion()) !== FALSE){ ?>
                        <a href="<?php echo $this->GoCristy_model->base_link()?>/admin/upgrade" title="<?php echo $this->lang->line('btn_upgrade')?>"><div class="alert alert-warning text-center" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button><?php echo $this->lang->line('upgrade_newlast_alert')?></div></a>
                        <?php } ?>
