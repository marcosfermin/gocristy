...
<html lang="<?php echo $this->session->userdata('fronlang_iso') . '-' . strtoupper($this->GoCristy_model->getCountryCode($this->session->userdata('fronlang_iso'))) ?>" prefix="og: http://ogp.me/ns#">
    <head>
        <?php echo $meta_tags?>
        <?php echo link_tag('templates/gocristydefault/imgs/favicon.ico', 'shortcut icon', 'image/ico');?>
        <!-- Bootstrap Core CSS -->
        <?php echo $core_css ?>
    ...
    <body id="page-top" class="index">
        ...
        <!-- Custom CSS -->
        <?php echo link_tag('templates/gocristydefault/css/gocristydefault.min.css') ?>
