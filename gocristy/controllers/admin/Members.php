...
class Members extends CI_Controller {
    ...
    public function index() {
        ...
        $num_link = 10;
        $base_url = $this->GoCristy_model->base_link(). '/admin/members/';
        // Pageination config
    ...
    public function confirm() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            //Validation passed
            //Add the user
            $this->GoCristy_admin_model->createUser(TRUE);
    ...
    public function editUser() {
        ...
        if($this->uri->segment(4)){
            ...
            $users = $this->GoCristy_admin_model->getUser($this->uri->segment(4), 'member');
            if($users !== FALSE){
