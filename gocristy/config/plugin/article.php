...
$plugin_config['plugin_file_path']   = array(
    ...
    FCPATH . '/gocristy/config/plugin/article.php',
    FCPATH . '/gocristy/controllers/admin/plugin/Article.php',
    FCPATH . '/gocristy/models/plugin/Article_model.php',
    FCPATH . '/gocristy/modules/plugin/controllers/Article.php',
    FCPATH . '/gocristy/modules/plugin/views/templates/gocristydefault/article/',
    FCPATH . '/gocristy/views/admin/plugin/article/',
    FCPATH . '/gocristy/language/dutch/plugin/article_lang.php',
    FCPATH . '/gocristy/language/english/plugin/article_lang.php',
    FCPATH . '/gocristy/language/italian/plugin/article_lang.php',
    FCPATH . '/gocristy/language/spanish/plugin/article_lang.php',
    FCPATH . '/gocristy/language/thai/plugin/article_lang.php',
);
