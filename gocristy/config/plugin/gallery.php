 ...
 * $this->GoCristy_model->getPluginConfig('plugin_config_filename', 'item index name');
 * Ex. $this->GoCristy_model->getPluginConfig('article', 'plugin_name');
 * 
 */
...
$plugin_config['plugin_author']  = 'gocristy'; /* For your name */
...
$plugin_config['plugin_file_path']   = array(
    ...
    FCPATH . '/gocristy/config/plugin/gallery.php',
    FCPATH . '/gocristy/controllers/admin/plugin/Gallery.php',
    FCPATH . '/gocristy/models/plugin/Gallery_model.php',
    FCPATH . '/gocristy/modules/plugin/controllers/Gallery.php',
    FCPATH . '/gocristy/modules/plugin/views/templates/gocristydefault/gallery/',
    FCPATH . '/gocristy/views/admin/plugin/gallery/',
    FCPATH . '/gocristy/language/dutch/plugin/gallery_lang.php',
    FCPATH . '/gocristy/language/english/plugin/gallery_lang.php',
    FCPATH . '/gocristy/language/italian/plugin/gallery_lang.php',
    FCPATH . '/gocristy/language/spanish/plugin/gallery_lang.php',
    FCPATH . '/gocristy/language/thai/plugin/gallery_lang.php',
);
