...
$config['sess_cookie_name'] = 'GoCristy_sess';
...
$config['cookie_prefix']	= 'gocristycookie';
...
$config['csrf_token_name'] = 'csrf_gocristy';
$config['csrf_cookie_name'] = 'csrf_cookie_gocristy';
