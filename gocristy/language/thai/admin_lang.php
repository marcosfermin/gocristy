...
$lang['dashboard_rssnews']	= "ข่าว GOCRISTY CMS ล่าสุด 6 รายการ";
...
$lang['ga_no_settings']         = 'Google Analytics ไม่ได้ถูกตั้งค่าบน <a href="'.get_instance()->GoCristy_model->base_link().'/'.'admin/settings#ga_client_id" title="การตั้งค่าเว็บไซต์"><b>การตั้งค่าเว็บไซต์</b></a>!';
$lang['ga_days']		= "วัน";
...
//Dashboard
$lang['dash_welcome']		= "ยินดีต้อนรับเข้าสู่เบื้องหลัง GOCRISTY CMS";
...
$lang['dash_gocristy_link']	= "เว็บไซต์ GOCRISTY CMS อย่างเป็นทางการ";

// EMAILS FORGET PASSWORD
$lang['email_reset_subject']    = "รีเซ็ตรหัสผ่านของคุณ GOCRISTY-CMS";
...
$lang['settings_assets_static_domain_remark']	= "(ตัวอย่าง: https://cdn.gocristy.com) โดเมนแบบคงที่นี้ต้องใช้เส้นทางเดียวกับโดเมนต้นทาง";
...
$lang['upgrade_newlast_alert']          = "GOCRISTY-CMS มีเวอร์ชั่นอัพเกรดมาใหม่. กรุณาอัพเกรดเดี๋ยวนี้!";
$lang['upgrade_lastver_alert']          = "GOCRISTY-CMS ของคุณคือเวอร์ชั่นล่าสุดแล้ว!";
