...
tinymce.PluginManager.add('gocristyfile', function(editor) {

	tinymce.activeEditor.settings.file_browser_callback = gocristyFileBrowser;
        
        function gocristyFileBrowser (field_name, url, type, win) {
